...
# Prepares data by creating three traces/lines to plot, each corrresponding to
# date and each being either death, recovered, or unrecovered on the y axis.
# They also each have corrresponding names and are displayed as lines.
